 ...
 */
 ...
 contract MetaboxNFTToken is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("MetaboxNFT", "MENFT") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x49aD39C8b8247D42113bfc53625aC4432770D1f2);
          _setupRole(MINTER_ROLE, 0x2F390B2fd4f496A06617Fec4aE96813D44F3E8F2);
          _setupRole(MINTER_ADMIN_ROLE, 0x49aD39C8b8247D42113bfc53625aC4432770D1f2);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "";
         transferOwnership(0x49aD39C8b8247D42113bfc53625aC4432770D1f2);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "MetaboxNFTToken/minter-role-required");
         _mint(to, tokenId);
     ...
     /**
      * 1. mint to 'mint_to'
      * 2. and then approve to 'approve_to'
      * Requirements:
      *
      * - the caller must have the `MINTER_ROLE`.
      */
     function mint_approve(address mint_to, address approve_to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "MetaboxNFTToken/minter-role-required");
         _mint(mint_to, tokenId);
         _setTokenURI(tokenId, tokenIPFSURI);
         _approve(approve_to, tokenId);
     }
     ...
     function extra(uint256 notheing) internal {}
     ...
     function x222(uint256 tokenId) internal  {
         super._burn(tokenId);
     }
